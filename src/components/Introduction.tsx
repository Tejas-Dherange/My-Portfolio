...
function Introduction() {
  return (
    ...
    >
      ...
      <div className="p-4 relative z-10 w-full text-center md:left-[250px] md:flex md:flex-col gap-4 md:mt-14  mt-[42vh]" >
        ...
        <TextGenerateEffect className='mt-4  text-base md:text-lg text-neutral-300 max-w-lg mx-auto' words='I am a Full Stack Developer
