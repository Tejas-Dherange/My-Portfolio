  ...
  return (
    <div className="h-full p-20 rounded-md   antialiased dark:bg-black bg-white  dark:bg-dot-white/[0.2] bg-dot-black/[0.2] items-center justify-center   ">
      ...
      <div className="  flex gap-5 md:gap-10 md:justify-center items-center flex-wrap mt-10 md:mt-16">
        {skils.map((skill) => (
          <div key={skill.id} className="card p-3 cursor-pointer rounded transform transition-transform duration-300 hover:scale-105 hover:shadow-lg  hover:bg-slate-800  w-[125px] md:w-40 flex flex-col items-center justify-center">
            <img src={`/TeckStack/${skill.image}`} alt={skill.title} />
